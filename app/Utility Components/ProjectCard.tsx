...
const ProjectCard: FunctionComponent<{
  ...
  return (
    <div>
      ...
      {showDetail && (
        <div className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 text-black bg-gray-300 md:grid-cols-2 gap-x-12 dark:text-white dark:bg-dark-100 rounded-lg">
          <div>
