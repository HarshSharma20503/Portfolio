  ...
  return (
    <ThemeProvider defaultTheme="dark" attribute='class'>
      <div className='grid grid-cols-12 gap-6 px-5 my-14 lg:mb-0 md:mb-16 sm:px-20 md:px-32 lg:px-2 xl:px-28 2xl:px-40' >
        ...
        <div className='flex flex-col col-span-12 bg-white rounded-2xl dark:text-white lg:col-span-9 dark:bg-dark-500 shadow-custom-light dark:shadow-custom-dark'>
          <Mainbar />
        </div>
